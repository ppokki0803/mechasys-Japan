              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">Mechasys (9373-6817 Québec inc.)</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500 mb-1">所在地</p>
                    <p className="text-gray-900">160 Saint Viateur St. East, Suite 702<br />Montreal, Quebec, H2T 1A8, Canada</p>
                  </div>
                  <div>
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <a href="https://mechasys.bamboohr.com/careers" target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="bg-[#0047bb] hover:bg-[#003399] rounded-full px-8">
                採用情報を見る
                <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
            </a>
