        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <Link href="#industries">
              <Button size="lg" className="bg-[#0047bb] hover:bg-[#003399] text-white rounded-full">
                導入事例を見る
              ...
              <motion.div key={industry.title} variants={fadeInUp}>
                <div className="relative h-64 rounded-xl overflow-hidden group cursor-pointer">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <p className="text-sm text-white/70">{industry.titleEn}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4 hover:text-[#0047bb] transition-colors">
